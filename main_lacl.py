...
parser.add_argument('--moco-k', default=5, type=int,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset_file = os.path.join(args.data, 'train.txt')
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            }, is_best=False, filename='{}/checkpoint_{:04d}.pth.tar'.format(args.checkpoint, epoch))
